...
<body>
	<div class="container border10">
		...
		<div style="display:inline-block;margin:-25px 0px 15px 0px;">
			<?php
			include ('include/event/treasurehuntmenu.html');
			?>
		</div>
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-default backgroundColor font">
					...
					$newsItems = $repository->getLatestNewsForCategory(EventEnumertion::TreasureHunt, MonthEnumertion::January, MonthEnumertion::December);
