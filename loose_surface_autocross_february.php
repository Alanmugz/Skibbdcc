...
<html>
<head>
	<title>Loose Surface AutoCross(February)</title>
...
<body>
	<div class="container border10">
		...
		<div style="display:inline-block;margin:-25px 0px 15px 0px;">
			<?php
			include ('include/event/loose_surface_autocrossmenu_february.html');
			?>
		</div>
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-default backgroundColor font">
					<div class="panel-heading">
						<h3 class="panel-title"><?php echo $LooseSurfaceAutocrossFebruaryDetails ?><br /><h6><?php echo $LooseSurfaceAutocrossFebruaryCOC ?></h6></h3>
					</div>
					<?php
					$repository = new NewsRepository;
					$repository->connect("skibbdcc_news");

					$newsItems = $repository->getLatestNewsForCategory(EventEnumertion::LSAutoCross, MonthEnumertion::January, MonthEnumertion::May);
