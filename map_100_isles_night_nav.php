...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head><!--  ščřžýŠČŘŽÝ -->
  ...
  <div id="container">
	...
	<div id="submenu">
				<ul id="nav">
					<li><a href="100_isles_night_nav.html" class="selected">Latest</a></li>
					<li><a href="files/100Isles/regs_2014.doc">Regs</a></li>
					<li><a href="files/100Isles/regs_2014.doc">Entry Form</a></li>
					<li><a href="map_100_isles_night_nav.html">Map</a></li> 
