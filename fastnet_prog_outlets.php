...
<!-- Bottom menu -->
 <?php
    include ('includebootstrap\event\fastnetrallybottommenu.html');    include ('includebootstrap/event/fastnetrallybottommenu.html'); ?>
        ...
        <div class="col-md-8">
            <div class = "panel panel-default backgroundColor font">
                <div class = "panel-heading">
                    <h3 class = "panel-title">Westlodge Fastnet Rally <?php echo $rallyEventYear; ?> - Programme Outlets</h3>
                </div>
            </div>
        </div>
