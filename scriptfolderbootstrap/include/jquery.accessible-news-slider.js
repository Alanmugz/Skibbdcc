		...
		return this.each(function(){
			...
			var container = {
				...
				set: function(position){
					...
					var img = jQuery('<img class="slider_bigimg"></img>');
					...
					para.html("<h1><a href='" + jQuery('a', story).attr('href') + "' rel='nofollow'>" + title + "</a></h1>" + "<p>" + jQuery(settings.contentDescription, story).html() + "</p>");
					var imgWrapper = jQuery("<a href='" + jQuery('a', story).attr('href') + "'/>");
					imgWrapper.append(img);
					_content.empty();
					_content.append(imgWrapper);
