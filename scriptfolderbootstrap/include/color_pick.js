...
function ColorPicker(){
	...
	for(var i=0;i<total;i++){
		...
		cp_contents += '<TD BGCOLOR="'+colors[i]+'"><FONT SIZE="-2"><A HREF="#" onClick="'+windowRef+'ColorPicker_pickColor(\''+colors[i]+'\','+windowRef+'window.popupWindowObjects['+cp.index+']);return false;" '+mo+' STYLE="text-decoration:none;">&nbsp;&nbsp;&nbsp;</A></FONT></TD>';
