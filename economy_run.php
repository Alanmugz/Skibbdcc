...
<body>
	<div class="container border10">
		...
		<div style="display:inline-block;margin:-25px 0px 15px 0px;">
			<?php
			include ('include/event/economyrunmenu.html');
			?>
		</div>
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-default backgroundColor font">
					...
					$newsItems = $repository->getLatestNewsForCategory(EventEnumertion::EconomyRun, MonthEnumertion::January, MonthEnumertion::December);
