 ...
 <head><!--  ščřžýŠČŘŽÝ -->
  ...
  <div id="container">
	...
	<div id="slide-runner">
		...
		<a href=""><img id="slide-img-8" src="images/slider/img15.jpg" class="slide" alt="" width="1000px"/></a>   
		<a href=""><img id="slide-img-2" src="images/slider/img2.jpg" class="slide" alt="" width="1000px"/></a>
		<a href=""><img id="slide-img-3" src="images/slider/img11.jpg" class="slide" alt="" width="1000px"/></a>
		...
		<a href=""><img id="slide-img-6" src="images/slider/img13.jpg" class="slide" alt="" width="1000px"/></a>
		<a href=""><img id="slide-img-7" src="images/slider/img9.jpg" class="slide" alt="" width="1000px"/></a>    
	</div>
	
	<!--content featured gallery here -->
   </div>
   <script type="text/javascript"> 
    if(!window.slider) var slider={};slider.data=[{"id":"slide-img-1","client":"nature beauty","desc":"nature beauty photography"},{"id":"slide-img-8","client":"nature beauty","desc":"add your description here"},{"id":"slide-img-2","client":"nature beauty","desc":"add your description here"},{"id":"slide-img-3","client":"nature beauty","desc":"add your description here"},{"id":"slide-img-4","client":"nature beauty","desc":"add your description here"},{"id":"slide-img-5","client":"nature beauty","desc":"add your description here"},{"id":"slide-img-6","client":"nature beauty","desc":"add your description here"},{"id":"slide-img-7","client":"nature beauty","desc":"add your description here"}];
   </script>
   </div></div><!--/header-->
	...
	<div class="wrapper">
		...
		<div id="news">
			<div id='pageheader'>
				...
				<img style = "margin-left: 15px;"src="images/adverts/Clonakilty-Potatoes.jpg" alt="?" width="650px"/>
