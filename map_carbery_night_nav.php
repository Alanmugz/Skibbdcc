...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head><!--  ščřžýŠČŘŽÝ -->
  ...
  <title>Map Carbery Night Nav</title>  
  ...
  <div id="container">
	...
	<div id="submenu">
				<ul id="nav">
					<li><a href="carbery_night_nav.html">Latest</a></li>
					<li><a href="files/carbery_night_nav/13_regs.pdf">Regs</a></li>
					<li><a href="#">Entry Form</a></li>
					<li><a href="map_carbery_night_nav.html" class="selected">Map</a></li>
