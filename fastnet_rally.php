		...
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-default backgroundColor font">
					...
					<p class="setmargin">
						<img style="float: left; border: 1px dotted black;  margin: 0px 10px 15px 0px;" src="<?php echo "scriptfolder/upload/".$news->getImage(); ?>" width="<?php echo $news->getImgwidth(); ?>" height="<?php echo $news->getImgheight(); ?>">
