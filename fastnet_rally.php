...
<body>
	...
	<div class="container border10">
		...
		<!--<div class="alert alert-danger font">
			<strong>Alert !! </strong>Sunday, 30 October 2016 — Daylight Saving Time Ends. Clocks move backward 1 hour.
		</div>-->
		...
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-default backgroundColor font">
					...
					from the competitor's section on the menu below or by clicking
						<a href="files/fastnet_2016/regs.doc">here</a>.
						<br />
						<br />
				...
				want an enjoyable cost effective weekend.
						<br />
						<br />
