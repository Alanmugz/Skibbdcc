...
<head>
	...
	<meta name="keywords" content="Skibbereen and District Car Club, Skibbdcc, Westlodge Hotel, Skibbereen Motor Club, Fastnet Rally, Awards Night" />
				...
				<div class="panel panel-default backgroundColor font">
					<div class="panel-heading">
						<h3 class="panel-title">
							<?php echo $AwardsNightDetails ?>
							<h6><?php echo $AwardsNightTickets ?></h6>
						</h3>
					</div>
					<?php
					...
					$newsItems = $repository->getLatestNewsForCategory(EventEnumertion::AwardsNight, MonthEnumertion::January, MonthEnumertion::December);
